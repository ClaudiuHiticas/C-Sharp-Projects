...
namespace Login {
    ...
    public partial class Database1DataSet4 : global::System.Data.DataSet {
        ...
        public partial class ComenziDataTable : global::System.Data.TypedTableBase<ComenziRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ComenziRow AddComenziRow(string Nume, int Masa, int Cantitate, double Pret) {
...
namespace Login.Database1DataSet4TableAdapters {
    ...
    public partial class ComenziTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Comenzi] ([Nume], [Masa], [Cantitate], [Pret]) VALUES (@Nume, " +
                "@Masa, @Cantitate, @Pret);\r\nSELECT ID, Nume, Masa, Cantitate, Pret FROM Comenzi " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Comenzi] SET [Nume] = @Nume, [Masa] = @Masa, [Cantitate] = @Cantitate, [Pret] = @Pret WHERE (([ID] = @Original_ID) AND ([Nume] = @Original_Nume) AND ([Masa] = @Original_Masa) AND ([Cantitate] = @Original_Cantitate) AND ([Pret] = @Original_Pret));
SELECT ID, Nume, Masa, Cantitate, Pret FROM Comenzi WHERE (ID = @ID)";
        ...
        public virtual int Fill(Database1DataSet4.ComenziDataTable dataTable) {
        ...
        public virtual Database1DataSet4.ComenziDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet4.ComenziDataTable dataTable = new Database1DataSet4.ComenziDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet4.ComenziDataTable dataTable) {
        ...
        public virtual int Insert(string Nume, int Masa, int Cantitate, double Pret) {
            if ((Nume == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(Masa));
        ...
        public virtual int Update(string Nume, int Masa, int Cantitate, double Pret, int Original_ID, string Original_Nume, int Original_Masa, int Original_Cantitate, double Original_Pret, int ID) {
            if ((Nume == null)) {
                throw new global::System.ArgumentNullException("Nume");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Masa));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_Masa));
        ...
        public virtual int Update(string Nume, int Masa, int Cantitate, double Pret, int Original_ID, string Original_Nume, int Original_Masa, int Original_Cantitate, double Original_Pret) {
            return this.Update(Nume, Masa, Cantitate, Pret, Original_ID, Original_Nume, Original_Masa, Original_Cantitate, Original_Pret, Original_ID);
        }
    }
