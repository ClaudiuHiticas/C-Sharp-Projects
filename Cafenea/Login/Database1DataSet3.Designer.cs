...
namespace Login {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class ComenziDataTable : global::System.Data.TypedTableBase<ComenziRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ComenziRow AddComenziRow(int ID, string Nume, int Masa, int Cantitate, double Pret) {
        ...
        public partial class ComenziRow : global::System.Data.DataRow {
            ...
            public int Masa {
                get {
                    return ((int)(this[this.tableComenzi.MasaColumn]));
                }
                set {
                    this[this.tableComenzi.MasaColumn] = value;
                }
            }
            ...
            public double Pret {
                get {
                    return ((double)(this[this.tableComenzi.PretColumn]));
                }
                set {
...
namespace Login.Database1DataSet3TableAdapters {
    ...
    public partial class ComenziTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Comenzi] WHERE (([ID] = @Original_ID) AND ([Nume] = @Original_" +
                "Nume) AND ([Masa] = @Original_Masa) AND ([Cantitate] = @Original_Cantitate) AND " +
                "([Pret] = @Original_Pret))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Comenzi] ([ID], [Nume], [Masa], [Cantitate], [Pret]) VALUES (@" +
                "ID, @Nume, @Masa, @Cantitate, @Pret);\r\nSELECT ID, Nume, Masa, Cantitate, Pret FR" +
                "OM Comenzi WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Comenzi] SET [ID] = @ID, [Nume] = @Nume, [Masa] = @Masa, [Cantitate] = @Cantitate, [Pret] = @Pret WHERE (([ID] = @Original_ID) AND ([Nume] = @Original_Nume) AND ([Masa] = @Original_Masa) AND ([Cantitate] = @Original_Cantitate) AND ([Pret] = @Original_Pret));
SELECT ID, Nume, Masa, Cantitate, Pret FROM Comenzi WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Nume, Masa, Cantitate, Pret FROM dbo.Comenzi";
        ...
        public virtual int Fill(Database1DataSet3.ComenziDataTable dataTable) {
        ...
        public virtual Database1DataSet3.ComenziDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.ComenziDataTable dataTable = new Database1DataSet3.ComenziDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.ComenziDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Nume, int Original_Masa, int Original_Cantitate, double Original_Pret) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_Masa));
        ...
        public virtual int Insert(int ID, string Nume, int Masa, int Cantitate, double Pret) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((double)(Pret));
        ...
        public virtual int Update(int ID, string Nume, int Masa, int Cantitate, double Pret, int Original_ID, string Original_Nume, int Original_Masa, int Original_Cantitate, double Original_Pret) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(Pret));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_Masa));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nume, int Masa, int Cantitate, double Pret, int Original_ID, string Original_Nume, int Original_Masa, int Original_Cantitate, double Original_Pret) {
            return this.Update(Original_ID, Nume, Masa, Cantitate, Pret, Original_ID, Original_Nume, Original_Masa, Original_Cantitate, Original_Pret);
        }
    }
